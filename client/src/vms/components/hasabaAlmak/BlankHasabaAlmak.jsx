  ...
  const generatePdf = () => {
    const documentDefinition = {
      ...
      content: [
        ...
        { text: '\n\n\n\n\n' },
        { text: `Belgi:   ${'4/-4346' || ''}`, fontSize: fontSizeBlankHeader, italics, bold },
        { text: `Sene:   ${'11.04.2019' || ''}`, fontSize: fontSizeBlankHeader, italics, bold },
        { text: '\n\n' },
        {
          columns: [
            { text: ' ' },
            {
              ...
              text: `${'Türkmenistanyň Döwlet Migrasiýa'}\n${'Gullugynyň Balkan welaýaty'} boýunça müdürliginiň Garabogaz şäherbölümine`,
            },
          ],
        },
        { text: '\n\n' },
        {
          ...
          text: [
            ...
            { text: 'Türkmenistana gelendigi sebäpli ', bold },
            { text: 'hasaba almagyňyzy  ' },
...
export default BlankHasabaAlmak;